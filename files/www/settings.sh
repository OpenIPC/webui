...
echo '          <td>logLevel</td>'
echo '          <td>'
echo '            <select autocomplete="off" name=".system.logLevel">'
...
echo '          <td><input placeholder="/etc/sensors/imx222_1080p_line.ini" name=".system.sensorConfig" value="'${sensorConfig}'"></td>'
echo '        </tr>'
echo '        <tr title="set custom directory for sensor configs">'
echo '          <td>sensorConfigDir</td>'
echo '          <td><input placeholder="/etc/sensors" name=".system.sensorConfigDir" value="'${sensorConfigDir}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>webPort</td>'
echo '          <td><input placeholder="80" name=".system.webPort" value="'${webPort}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>staticDir</td>'
echo '          <td><input placeholder="/var/www/html" name=".system.staticDir" value="'${staticDir}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>httpsPort</td>'
echo '          <td><input placeholder="443" name=".system.httpsPort" value="'${httpsPort}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>httpsCertificate</td>'
echo '          <td><input placeholder="/etc/ssl/certs/www.example.com.crt" name=".system.httpsCertificate" value="'${httpsCertificate}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>httpsCertificateKey</td>'
echo '          <td><input placeholder="/etc/ssl/private/www.example.com.key" name=".system.httpsCertificateKey" value="'${httpsCertificateKey}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>updateChannel</td>'
echo '          <td>'
echo '            <select name=".system.updateChannel">'
...
echo '          <td>buffer</td>'
echo '          <td><input placeholder="1024" name=".system.buffer" value="'${buffer}'"></td>'
echo '        </tr>'
echo '<!--                        isp                      -->        '
...
echo '          <td>'
echo '            <select autocomplete="off" name=".isp.slowShutter">'
...
echo '          <td>'
echo '            <select name=".isp.antiFlicker">'
...
echo '          <td><input placeholder="8" name=".isp.alignWidth" value="'${alignWidth}'"></td>'
echo '        </tr>  '
echo '        <tr title="4 for small memory systems and 10 and more for performant SoCs">'
echo '          <td>blkCnt</td>'
echo '          <td><input placeholder="4" name=".isp.blkCnt" value="'${blkCnt}'"></td>'
echo '        </tr>  '
echo '        <tr title="in Kbytes">'
echo '          <td>threadStackSize</td>'
echo '          <td><input placeholder="16" name=".isp.threadStackSize value="'${threadStackSize}'""></td>'
echo '        </tr>  '
echo '        <tr title="Used to implement dynamic range compression">'
echo '          <td>drc</td>'
echo '          <td><input placeholder="300" name=".isp.drc" value="'${drc}'"></td>'
echo '        </tr>'
echo '<!--                        image                      -->        '
...
echo '          <td>contrast</td>'
echo '          <td><input placeholder="auto" name=".image.contrast" value="'${contrast}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>hue</td>'
echo '          <td><input placeholder="50" name=".image.hue" value="'${hue}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>saturation</td>'
echo '          <td><input placeholder="50" name=".image.saturation" value="'${saturation}'"></td>'
echo '        </tr>  '
echo '        <tr title="auto or 1-99 (50)">'
echo '          <td>luminance</td>'
echo '          <td><input placeholder="auto" name=".image.luminance" value="'${luminance}'"></td>'
echo '        </tr> '
echo '<!--                        osd                      -->        '
...
echo '        <tr>'
echo '          <td>font</td>'
echo '          <td><input placeholder="/usr/lib/fonts/fonts.bin" name=".osd.font" value="'${font}'"></td>'
echo '        </tr>'
echo '        <tr title="add '%f' to show milliseconds (consumes more resources)">'
echo '          <td>template</td>'
echo '          <td><input placeholder="%a %e %B %Y %H:%M:%S %Z" name=".osd.template" value="'${template}'"></td>'
echo '        </tr>  '
echo '        <tr title="positive values count from left and top '
echo 'negative ones from right and bottom">'
echo '          <td>posX</td>'
echo '          <td><input placeholder="-100" name=".osd.posX" value="'${posX}'"></td>'
echo '        </tr>'
echo '        <tr title="positive values count from left and top '
echo 'negative ones from right and bottom">'
echo '          <td>posY</td>'
echo '          <td><input placeholder="-100" name=".osd.posY" value="'${posY}'"></td>'
echo '        </tr>'
echo '<!--                        nightMode                      -->        '
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".nightMode.enabled">'
...
echo '          <td><input placeholder="62" name=".nightMode.irSensorPin" value="'${irSensorPin}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>irSensorPinInvert</td>'
echo '          <td>'
echo '            <select name=".nightMode.irSensorPinInvert">'
...
echo '          <td><input placeholder="1" name=".nightMode.irCutPin1" value="'${irCutPin1}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>irCutPin2</td>'
echo '          <td><input placeholder="2" name=".nightMode.irCutPin2" value="'${irCutPin2}'"></td>'
echo '        </tr>'
...
echo '          <td><input placeholder="150" name=".nightMode.pinSwitchDelayUs" value="'${pinSwitchDelayUs}'"></td>'
echo '        </tr>'
echo '        <tr title="turn on backlight illumination when night mode is on">'
echo '          <td>backlightPin</td>'
echo '          <td><input placeholder="65" name=".nightMode.backlightPin" value="'${backlightPin}'"></td>'
echo '        </tr>  '
echo '        <tr title="use /night/{invert,on,off} endpoints to change mode by API for remote callers">'
echo '          <td>nightAPI</td>'
echo '          <td>'
echo '            <select name=".nightMode.nightAPI">'
...
echo '          <td><input placeholder="300" name=".nightMode.drcOverride" value="'${drcOverride}'"></td>'
echo '        </tr>'
echo '<!--                        records                      -->        '
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".records.enabled">'
...
echo '        <tr>'
echo '          <td>path</td>'
echo '          <td><input placeholder="/mnt/mmc/%Y/%m/%d/%H.mp4" name=".records.path" value="'${path}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>maxUsage</td>'
echo '          <td><input placeholder="95" name=".records.maxUsage" value="'${maxUsage}'"></td>'
echo '        </tr>  '
echo '<!--                        video0                      -->'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".video0.enabled">'
...
echo '        <tr>'
echo '          <td>size</td>'
echo '          <td><input placeholder="1920x1080" name=".video0.size" value="'${video0_size}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>fps</td>'
echo '          <td><input placeholder="25" name=".video0.fps" value="'${video0_fps}'"></td>'
echo '        </tr>'
echo '        <tr title="Kbits per second">'
echo '          <td>bitrate</td>'
echo '          <td><input placeholder="4096" name=".video0.bitrate" value="'${video0_bitrate}'"></td>'
echo '        </tr>  '
echo '        <tr title="send I-frame each 1 second">'
echo '          <td>gopSize</td>'
echo '          <td><input placeholder="1" name=".video0.gopSize" value="'${gopSize}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>gopMode</td>'
echo '          <td>'
echo '            <select name=".video0.gopMode">'
...
echo '          <td>rcMode</td>'
echo '          <td>'
echo '            <select name=".video0.rcMode">'
...
echo '        <tr>'
echo '          <td>crop</td>'
echo '          <td><input placeholder="0x0x960x540" name=".video0.crop" value="'${crop}'"></td>'
echo '        </tr>'
echo '<!--                        video1                      -->'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".video1.enabled">'
...
echo '        <tr>'
echo '          <td>size</td>'
echo '          <td><input placeholder="704x576" name=".video1.size" value="'${video1_size}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>fps</td>'
echo '          <td><input placeholder="15" name=".video1.fps" value="'${video1_fps}'"></td>'
echo '        </tr>'
echo '<!--                        jpeg                      -->'
...
echo '        <tr>'
echo '          <td>size</td>'
echo '          <td><input placeholder="1920x1080" name=".jpeg.size" value="'${jpeg_size}'"></td>'
echo '        </tr>'
echo '        <tr title="[1..99] jpeg quality">'
echo '          <td>qfactor</td>'
echo '          <td><input placeholder="50" name=".jpeg.qfactor" value="'${qfactor}'"></td>'
echo '        </tr>'
echo '        <tr title="make additional step to transform snapshot to Progressive JPEG">'
echo '          <td>toProgressive</td>'
echo '          <td>'
echo '            <select name=".jpeg.toProgressive">'
...
echo '        <tr>'
echo '          <td>size</td>'
echo '          <td><input placeholder="640x360" name=".mjpeg.size" value="'${mjpeg_size}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>fps</td>'
echo '          <td><input placeholder="5" name=".mjpeg.fps" value="'${mjpeg_fps}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>bitrate</td>'
echo '          <td><input placeholder="1024" name=".mjpeg.bitrate" value="'${mjpeg_bitrate}'"></td>'
echo '        </tr>  '
echo '<!--                        audio                      -->'
audio_enabled=`yaml-cli -g .audio.enabled`
       volume=`yaml-cli -g .audio.volume`
        srate=`yaml-cli -g .audio.srate`
   udio_codec=`yaml-cli -g .audio.codec`
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".audio.enabled">'
...
echo '        <tr>'
echo '          <td>volume</td>'
echo '          <td><input placeholder="auto" name=".audio.volume" value="'${volume}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>srate</td>'
echo '          <td><input placeholder="8000" name=".audio.srate" value="'${srate}'"></td>'
echo '        </tr>  '
echo '        <tr title="select default codec for RTSP and MP4 encoding">  '
echo '          <td>codec</td>'
echo '          <td>'
echo '            <select name=".audio.codec">'
...
echo '          <td>'
echo '            <select name=".audio.outputEnabled">'
...
echo '        <tr>'
echo '          <td>port</td>'
echo '          <td><input placeholder="554" name=".rtsp.port" value="'${rtsp_port}'"></td>'
echo '        </tr>'
echo '<!--                        hls                      -->'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".youtube.enabled">'
...
echo '        <tr>'
echo '          <td>key</td>'
echo '          <td><input placeholder="xxxx-xxxx-xxxx-xxxx-xxxx" name=".youtube.key" value="'${key}'"></td>'
echo '        </tr>'
echo '<!--                        motionDetect                      -->'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".motionDetect.enabled">'
...
echo '          <td>profile</td>'
echo '          <td>'
echo '            <select name=".motionDetect.profile">'
...
echo '          <td>'
echo '            <select name=".motionDetect.visualize">'
...
echo '          <td>debug</td>'
echo '          <td>'
echo '            <select name=".motionDetect.debug">'
...
echo '          <td><input placeholder="0x0x1296x760" name=".motionDetect.constraints" value="'${constraints}'"></td>'
echo '        </tr>'
echo '<!--                        ipeye                      -->'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".ipeye.enabled">'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".netip.enabled">'
...
echo '        <tr>'
echo '          <td>user</td>'
echo '          <td><input placeholder="admin" name=".netip.user" value="'${user}'"></td>'
echo '        </tr>'
echo '        <tr title="12345 password">'
echo '          <td>password</td>'
echo '          <td><input placeholder="6V0Y4HLF" name=".netip.password" value="'${password}'"></td>'
echo '        </tr>'
echo '        <tr>'
echo '          <td>port</td>'
echo '          <td><input placeholder="34567" name=".netip.netip_port" value="'${netip_port}'"></td>'
echo '        </tr>  '
echo '        <tr>'
echo '          <td>snapshots</td>'
echo '          <td>'
echo '            <select name=".netip.snapshots">'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".onvif.enabled">'
...
echo '          <td>enabled</td>'
echo '          <td>'
echo '            <select name=".watchdog.enabled">'
...
echo '        <tr>'
echo '          <td>timeout</td>'
echo '          <td><input placeholder="10" name=".watchdog.timeout" value="'${timeout}'"></td>'
echo '        </tr>'
echo '<!--                        submit                      -->'
echo '        <td></td>'
