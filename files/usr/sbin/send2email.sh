...
[ -z "$email_smtp_port"    ] && echo -e "SMTP port not found in config" && exit 3
[ -z "$email_from_address" ] && echo -e "Sender's address not found in config" && exit 4
[ -z "$email_to_address"   ] && echo -e "Recipient's address not found in config" && exit 5
