...
%>
<%in _header.cgi %>
<div class="alert alert-warning"><%= $t_ipeye_1 %></div>
...
<input type="hidden" name="mj_ipeye_enabled" id="mj_ipeye_enabled" value="true" class="form-control" placeholder="false">
