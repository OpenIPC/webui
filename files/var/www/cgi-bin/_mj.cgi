...
.nightMode.enabled|Ночной режим||boolean|true,false|false|
...
.nightMode.irCutPin1|GPIO-пин1 ИК-фильтр||number|1-100|1|
.nightMode.irCutPin2|GPIO-пин2 ИК-фильтр||number|1-100|2|
...
.video0.bitrate|Битрейт|kbps|number|1-4096|4096|
.video0.gopSize|Ключевой i-кадр/сек|number|1-20|1|
...
.video1.bitrate|Битрейт|kbps|number|1-4096|2048|
.video1.gopSize|Ключевой i-кадр/сек||number|1-20|1|
...
.jpeg.size|Разрешение снимка|px|string||1920x1080||
.jpeg.qfactor|Качество JPEG|%|range|1-100|50|
.jpeg.toProgressive|Progressive JPEG||boolean|true,false|false|
.mjpeg.size|Разрешение|px|string||640x360|
.mjpeg.fps|Частота кадров|fps|number|1-30|5|
.mjpeg.bitrate|Битрейт|kbps|number|1-4096|1024|
.audio.enabled|Аудио||boolean|true,false|false|
.audio.volume|Громкость|%|range|auto,1-100|auto|
...
.rtsp.enabled|Поддержка RTSP||boolean|true,false|true||
...
.motionDetect.profile|Профиль детекции||select|outdoor,indoor|outdoor|
.motionDetect.visualize|Visualize motion detection||boolean|true,false|true|
.motionDetect.debug|Отладка||boolean|true,false|true|
...
.netip.enabled|Поддержка NETIP||boolean|true,false|false|
.netip.user|NETIP пользователь||string||admin|
.netip.password-plain|NETIP пароль||string||12345|
.netip.password|NETIP хеш пароля||hidden||6V0Y4HLF|
.netip.port|NETIP порт||number|1-65535|34567|
