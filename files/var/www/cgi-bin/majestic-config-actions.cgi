...
<%in _header.cgi %>
<%
row_ "row-cols-1 row-cols-lg-2 g-4 mb-3"
  col_card_ "$tHeaderMjBackup"
    p "$tMjBackupInfo"
    button_link_to "$tButtonMjBackup" "/cgi-bin/majestic-config-backup.cgi" "primary"
  _col_card
  ...
  col_card_ "$tHeaderMjChanges"
    p "$tMjChangesInfo"
    button_link_to "$tButtonMjChanges" "/cgi-bin/majestic-config-compare.cgi" "primary"
  _col_card
